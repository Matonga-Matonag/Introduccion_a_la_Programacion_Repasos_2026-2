...
INICIO
    ...
    SI tipo_cliente == 1 y cantidad > 20:
        descuento_pct = 0.25
    SINO SI tipo_cliente == 1 y cantidad >= 10:
        descuento_pct = 0.15
    SINO SI tipo_cliente == 1:
        descuento_pct = 0.08
    SINO SI tipo_cliente == 2 y cantidad > 20:
        descuento_pct = 0.10
    SINO SI tipo_cliente == 2:
        descuento_pct = 0.00
    SINO:
...
> - Uso del `SINO` final como validación del tipo de cliente.
> - Las condiciones para el cliente VIP van de mayor a menor cantidad, para que el `SINO SI` las evalúe en el orden correcto.
